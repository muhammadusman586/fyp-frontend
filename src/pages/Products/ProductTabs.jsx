  ...
  return (
    <div className="flex flex-col md:flex-row">
      <section className="mr-[5rem]">
        <div
          className={`text-gray-600 flex-1 p-4 cursor-pointer text-lg ${
              ...
              <form onSubmit={submitHandler}>
                <div className="my-2">
                  ...
                  <select
                    ...
                    className="p-2 border rounded-lg xl:w-[40rem] text-gray-600"
                  >
                ...
                <button
                  ...
                  className="bg-pink-600 text-gray-600 py-2 px-4 rounded-lg"
                >
                  Submit
                </button>
              </form>
